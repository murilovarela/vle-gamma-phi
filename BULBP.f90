PROGRAM BULBP
  ...
  DO WHILE (X1 < 1)
    ...
    !INITIALIZE WITH PHI1 AND PHI2 EQUAL 1
    PHI1 = 1
    PHI2 = 1
    ...
    DO WHILE (SQRT(PA-PA2)**2 > ERROR)
      ...
      CALL PRECUBIC (T, TC1, PC1, W1, PA, CUB11, CUB21, CUB31, ACUB1, BCUB1, AC1, BZ1)
      CALL PRECUBIC (T, TC2, PC2, W2, PA, CUB12, CUB22, CUB32, ACUB2, BCUB2, AC2, BZ2)
...
SUBROUTINE PRECUBIC (T, TC, PC, W, P, CUB1, CUB2, CUB3, ACUB, BCUB, AC, BZ)
REAL, INTENT(IN) :: T, TC, PC, W, P
